...
ptpath = "/home/jianglongyu/Documents/models/cdc_full/image-l2-use_weight5-vimeo-d64-t8193-b0.0032-x-cosine-01-float32-aux0.0_2.pt"
...
def main(rank):
    ...
    for img in os.listdir(config.img_dir):
        if img.endswith(".png") or img.endswith(".jpg"):
            print_file_size(os.path.join(config.img_dir, img))
            ...
            print_file_size(os.path.join("./compressed_imgs", img))
            print("bpp:", bpp)
